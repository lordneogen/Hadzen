...
from .models import *
from .serializers import SER_Blog_LDC, SER_Blog_LDS_all
...
@api_view(['DELETE'])
def LDS_GET(request, id,us_id):
    count = LikeDisShareBl.objects.get(bl=id,user=us_id)
    count.delete()
...
def ALL_BLOGS(request):
    ...
    for x in obj:
        ...
        response_data = {
            ...
            'blog_detail': blog_serializer.data,
